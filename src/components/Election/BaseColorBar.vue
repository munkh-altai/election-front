...
export default {
  ...
  setup(props) {
    ...
    const chartOptionsBase = ref({
      chart: {
        type: 'bar',
        height: '300px',  // Set a fixed height or use dynamic height based on number of items
        events: {
          load: function() {
            const chart = this;
      ...
      plotOptions: {
        series: {
          ...
          // pointPadding: 0.01, // Adjust pointPadding
    ...
    const refreshChartData = () => {
      ...
      chartOptionsBase.value.chart.height = 10.8 * numberOfSection;
    ...
    return {
      isModalVisible, handleOk, handleCancel, columns, tableData, chartOptionsBase
    };
  }
};
</script>
