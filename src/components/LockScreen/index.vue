<template>
  <section class="LockScreen" v-if="lockScreen" :class="afterUnlock">
    <div
      ...
      :style="`background-image: url(${lockImg}); background-size: cover;`"
    ></div>
    <div class="content">
...
<!--        <img :src="userinfo.avatar" class="avatar" />-->
        <div class="username">{{userinfo.first_name}}</div>
        <a-input-password
      ...
      <div class="deviceStatus">
        ...
        <span class="onlineStatus">
          <img src="/assets/icons/onLine.ico" v-show="isOnline" />
          <img src="/assets/icons/offLine.ico" v-show="!isOnline" />
        </span>
        ...
        <a-tooltip>
          <template #title>{{isClickedUnlockBtn?'Болих':'Түгжээ тайлах'}}</template>
...
const initBg =
  'https://khankhulgun.mn/constellation.png'
...
export default defineComponent({
  ...
  setup() {
    ...
    const getDateTime = () => {
      ...
      return month + ' сарын ' + day + ' ' + ' ' + formatedWeek
    }
    ...
    const onUnlockScreen = async () => {
      ...
      const res = await api.userLogin({ login: userinfo.login, password: password.value })
      if (!password.value) {
